			...
			<div class="product-main">
              ...
              "contain": true
							...
							<div class="product-info summary entry-summary col col-fit product-summary">
								<nav class="woocommerce-breadcrumb breadcrumbs"><a href="<?= HOME ?>">Trang chủ</a> <span class="divider">&#47;</span>
									<a href="product">Sản phẩm</a> <span class="divider">&#47;</span>
								...
								<div class="full-bnt">
									<div class="nut-lien-he" style="margin-bottom : 10px;">
										<a href="#live_chat" class="modal_trigger pps-btn-img fancybox" title="Liên hệ" 7>
											<h3 style="margin-bottom:0;color:#fff !important;">
												...
												<span style="padding-left:10px;">ĐẶT MUA NHANH</span>
											</h3>
										</a>
									</div>
												...
												<form onsubmit="event.preventDefault();" class="wpcf7-form init" novalidate="novalidate" data-status="init">
													<div class="contact-form-view">
														<div class="contact-form-left">
															<div class="txt-01">
																<span class="wpcf7-form-control-wrap"><input type="text" id="txtDatHangName" name="txtDatHangName" value="" size="40" class="wpcf7-form-control wpcf7-text mb-0" aria-invalid="false" placeholder="Họ và tên" /></span> 
																<small id="spanDatHangName" style="min-height: 10px; color:red; padding-bottom: 10px;"></small>
															</div>
															<div class="txt-01">
																<span class="wpcf7-form-control-wrap "><input type="tel" id="txtDatHangPhone" name="txtDatHangPhone" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-tel wpcf7-validates-as-required wpcf7-validates-as-tel mb-0" aria-required="true" aria-invalid="false" placeholder="Số điện thoại *" /></span>
														...
														<div class="contact-form-right">
															...
															<div class="txt-01">
																<span class="wpcf7-form-control-wrap "><input type="text" id="txtDatHangAddress" name="txtDatHangAddress" value="" size="40" class="wpcf7-form-control wpcf7-text mb-0" aria-invalid="false" placeholder="Địa chỉ" /></span> 
														...
														<div class="txt-03"><input onclick="datHangSubmit()" type="submit" value="Gửi thông tin"/></div>
													</div>
								...
								<aside class="promo-online">
									<b>
										<i class="fa fa-mobile" aria-hidden="true"></i>GỌI NGAY ĐỂ CÓ GIÁ TỐT NHẤT</b>
								...
								<div class="product_meta">
									...
									<span class="posted_in">Danh mục: <a href="product/1/<?= $page['data']['danhmucurl'] ?>" rel="tag"><?= $page['data']['danhmuc'] ?></a></span>
