...
$pages = ceil($total / 6);
$categoryBlog = $data->getBlogCategory($currentPage, $page['idCategory'], 6);
...
<div class="shop-page-title category-page-title page-title ">
    <div class="page-title-inner flex-row  medium-flex-wrap container">
        <div class="flex-col flex-grow medium-text-center">
            <div class="is-large">
                <nav class="woocommerce-breadcrumb breadcrumbs"><a href="<?= HOME ?>">Trang chủ</a> <span class="divider">&#47;</span> <?= $page['title'] ?></nav>
            </div>
        </div><!-- .flex-left -->
    </div><!-- flex-row -->
</div><!-- .page-title -->
