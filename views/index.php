            ...
            <div class="col-inner">
               <ul class="sidebar-wrapper ul-reset ">
                  ...
                  <aside id="woocommerce_product_search-2" class="widget woocommerce widget_product_search">
                     <span class="widget-title "><span>TÌM KIẾM SẢN PHẨM</span></span>
                     <div class="is-divider small"></div>
               ...
               <section class="section list-product-home" id="section_3064680">
                  ...
                  <div class="section-content relative">
                     <div class="container section-title-container">
                        <h3 class="section-title section-title-bold"><b></b><span class="section-title-main red-tab">SẢN PHẨM MỚI</span><b></b></h3>
                     </div>
                     <!-- .section-title -->
