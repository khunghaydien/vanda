...
if (isset($_SESSION['weborderuser'])) {
    ...
    $transactionList =  $data->getAllTransactionType1($_SESSION['weborderuser']['id'], $dateAdded,$dateModified);
?>
        ...
        <div class="container">
            <div id="">
                <ul class="resp-tabs-list">
                    ...
                    <li class="resp-tab-item resp-tab-active"> Lịch sử nạp tiền</li>
                    <a href="user-money-info">
                        <li> Thu chi tài chính</li>
                    </a>
                </ul>
