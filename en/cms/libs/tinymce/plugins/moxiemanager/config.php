...
if($_SERVER['HTTP_HOST']=='localhost') { 
	$v_rootdir=$_SERVER["DOCUMENT_ROOT"]."/iso/uploads"; 
	$v_homedir='{proto}://{host}/iso/uploads/';
} else {
	$v_rootdir=$_SERVER["DOCUMENT_ROOT"]."/uploads"; 
	$v_homedir='{proto}://{host}/uploads/';
}
...
// Filesystem
//$moxieManagerConfig['filesystem.rootpath'] = $_SERVER["DOCUMENT_ROOT"]."/hocdi/uploads";  ///webroot/uploads';
$moxieManagerConfig['filesystem.rootpath'] = $v_rootdir;
...
// Local filesystem
//$moxieManagerConfig['filesystem.local.wwwroot'] = $_SERVER["DOCUMENT_ROOT"]."/hocdi/uploads";
$moxieManagerConfig['filesystem.local.wwwroot'] = $v_rootdir;
//$moxieManagerConfig['filesystem.local.urlprefix'] = '{proto}://{host}/hocdi/uploads/';
$moxieManagerConfig['filesystem.local.urlprefix'] = $v_homedir;
