...
<div class="shop-page-title category-page-title page-title ">
    <div class="page-title-inner flex-row  medium-flex-wrap container">
        <div class="flex-col flex-grow medium-text-center">
            <div class="is-large">
                <nav class="woocommerce-breadcrumb breadcrumbs"><a href="<?= HOME ?>">Home</a> <span class="divider">&#47;</span> Contact</nav>
            </div>
        </div><!-- .flex-left -->
    </div><!-- flex-row -->
</div><!-- .page-title -->
            ...
            <div class="page-inner">
               <div class="gmail_default">
                  ...
                  <p style="text-align: left; margin-left: 10%;">
                     <strong><em>Address: <?=$info['dia-chi']?></em></strong> <br>
                     <strong><em>Representative office address: <?=$info['dia-chi-2']?></em></strong>
                     <strong>
                        <em><br />
               ...
               <div id="comments" class="comments-area">
                  <div id="respond" class="comment-respond">
                     <h3 id="reply-title" class="comment-reply-title">Feedback<small><a rel="nofollow" id="cancel-comment-reply-link" href="lien-he.html#respond" style="display:none;">Hủy</a></small></h3>
                     <form  onsubmit="event.preventDefault();" class="comment-form" novalidate>
                        <p class="comment-notes"><span id="email-notes">Your email will not be publicly displayed.</span></p>
                        <p class="comment-form-comment">
                           <label for="txtContactTitle">Title <span class="required">*</span></label>
                        ...
                        <p class="comment-form-comment">
                           <label for="txtContactContent">Content <span class="required">*</span></label> 
                        ...
                        <p class="comment-form-author">
                           <label for="txtContactName">Full name <span class="required">*</span></label> 
                        ...
                        <p class="form-submit">
                           <input onclick="contactSubmit()" name="submit" type="submit" id="submit" class="submit" value="Submit" />
                        </p>
                     </form>
                  </div>
                  <!-- #respond -->
