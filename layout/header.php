...
<head>
    ...
    <link rel="alternate" type="application/rss+xml" title="Dòng thông tin VANDA &raquo;" href="feed" />
    <link rel="alternate" type="application/rss+xml" title="Dòng phản hồi VANDA &raquo;" href="comments/feed" />
    <link rel="alternate" type="application/rss+xml" title="vanda &raquo; TRANG CHỦ Dòng phản hồi" href="trang-chu/feed" />
    <script type="text/javascript">
        window._wpemojiSettings = {
            ...
            "svgExt": ".svg",
            "source": {
                "concatemoji": "https:\/\/vandas.vn\/wp-includes\/js\/wp-emoji-release.min.js?ver=5.7.2"
            }
        };
        ! function(e, a, t) {
                        ...
                        <div class="flex-col hide-for-medium flex-right w-100">
                            <ul class="header-nav header-nav-main nav nav-right nav-uppercase">
                                ...
                                <li class="html custom html_top_right_text">
                                    ...
                                    <span>Giờ làm việc: 8:30 - 17:30</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="flex-col hide-for-medium flex-right flex-grow">
                            <ul class="nav header-nav header-bottom-nav nav-right  nav-uppercase">
                                            ...
                                            <form method="post" class="searchform" action="search" >
                                                <div class="flex-row relative">
                                                    <div class="flex-col flex-grow">
                                                        <input type="search" class="mb-0" name="keyword" value="<?php if(isset($_REQUEST['keyword'])) echo $_REQUEST['keyword'];?>" placeholder="Nhập từ khóa..." required />
                                                    </div>
                                                    <!-- .flex-col -->
                                                    <div class="flex-col">
                                ...
                                <li class="cart-item has-icon has-dropdown">
                                    <div class="header-button">
                                        <a title="Tiếng Việt" class="header-cart-link icon primary button round is-small" style="background-color: #FFF;">
                                            <img src="template/images/vi.png" alt="VietNam">
                                        </a>
                                    </div>
                                    <ul class="nav-dropdown nav-dropdown-default fix-flag-block">
                                            <a href="en/<?=$thisUrl?>" title="Tiếng Anh" class="header-cart-link icon primary button round is-small"style="background-color: #FFF;">
                                                <img src="template/images/en.png" alt="VietNam">
                                            </a>
                                    </ul>
                                </li>
                            </ul>
